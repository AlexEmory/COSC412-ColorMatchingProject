public class paintMixing{
  public static void main(String[] args){
    ...
    double[] spectColor={100,178,178};
    double[] solution;
    solution=paintApprox4D(spectColor,paintC,paintM,paintY,paintK,10);
    System.out.println(solution[0]+" "+solution[1]+" "+solution[2]);
    System.out.print(solution[0]*paintC[0]+solution[1]*paintM[0]+solution[2]*paintY[0]+" "+solution[3]*paintK[1]);
    System.out.print(solution[0]*paintC[1]+solution[1]*paintM[1]+solution[2]*paintY[1]+" "+solution[3]*paintK[2]);
